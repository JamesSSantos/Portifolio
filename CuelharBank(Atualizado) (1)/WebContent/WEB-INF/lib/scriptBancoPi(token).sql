...
-- -----------------------------------------------------
-- Table `CuelharBank`.`ControleToken`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `CuelharBank`.`ControleToken` (
  `numeroToken` INT(6) NOT NULL,
  `dtToken` TIMESTAMP NOT NULL,
  PRIMARY KEY (`numeroToken`),
  UNIQUE INDEX `numeroToken_UNIQUE` (`numeroToken` ASC))
ENGINE = InnoDB;
