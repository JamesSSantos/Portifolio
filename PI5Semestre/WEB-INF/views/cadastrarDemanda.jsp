							...
							<div class="col-md-6 border-right ">
								...
								<div class="form-group">
									<label for="nomeDemanda" class="text-left">Nome da
										Demanda </label> <input id="nomeDemanda" name="nomeDemanda" type="text" class="form-control" placeholder="Ex: Ernst & Young" required>
								</div>
								...
								<div class="row">
									<div class="col-12"><label>Data de Duração da Demanda</label></div>
									<div class="col-md-6 ">
									...
									<div class="col-md-6 ">
										...
										<input id="dataTerminoProjeto" name="dataTerminoDemanda" type="date" class="form-control" pattern="dd/MM/yyyy">
									</div>
								</div>
							</div>
